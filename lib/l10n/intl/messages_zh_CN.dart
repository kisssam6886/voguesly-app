...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(p0) => "已复制 ${p0} 条日志到剪贴板";

  static String m24(p0) => "${p0}已复制";

  static String m25(p0) => "当前余额:${p0}";

  static String m26(p0) => "当前套餐: ${p0} · ";

  static String m27(p0) => "当前套餐:${p0}";

  static String m28(p0, p1, p2) => "设备: ${p0} ${p1} · Android ${p2}";

  static String m29(p0) => "时长 ${p0}";

  static String m30(p0) => "${p0}已过期";

  static String m31(p0, p1) => "${p0}\\n\\n=== 诊断信息(自动附带) ===\\n${p1}";

  static String m32(p0) => "${p0} 起";

  static String m33(p0) => "${p0}；已保持「系统代理（兼容模式）」承载流量";

  static String m34(p0) => "上次更新 · 今天 ${p0}";

  static String m35(p0, p1) => "上次更新 · ${p0} ${p1}";

  static String m36(p0) => "加载失败:${p0}";

  static String m37(p0, p1) => "加载失败:${p0}(code ${p1})";

  static String m38(p0) => "本机环境正常，易联正以${p0}接管中。";

  static String m39(p0) => "本机端口被 ${p0} 占用，易联核心可能无法绑定 —— 建议改用另一个端口。";

  static String m40(p0) => "本地端口 ${p0}";

  static String m41(p0) => "${p0} 个周期可选";

  static String m42(p0) => "${p0} 天";

  static String m43(p0) => "${p0} 个月";

  static String m44(p0) => "${p0} 人";

  static String m45(p0) => "${p0} 年";

  static String m46(p0) => "网络异常: ${p0}";

  static String m47(p0) => "有新版本 ${p0}";

  static String m48(p0) => "下单失败: ${p0}";

  static String m49(p0) => "订单号:${p0}";

  static String m50(p0) => "检测到其他代理正在运行(${p0})，请先关闭后再连接易联";

  static String m51(p0) => "检测到其他代理正在运行(${p0})，本次暂不启用易联 TUN";

  static String m52(p0) => "支付发起失败: ${p0}";

  static String m53(p0) => "套餐可同时连接 ${p0} 台设备；";

  static String m54(p0) => "指向易联 · ${p0}";

  static String m55(p0, p1) =>
      "${p0} 占用了 ${p1}，导致易联核心无法绑定 —— 这正是「界面显示已连接但上不了网」";

  static String m56(p0) => "公网流量正在走 ${p0}，但不是易联的虚拟网卡 ——";

  static String m57(p0) => "发送失败: ${p0}";

  static String m58(p0) => "限速 ${p0} Mbps";

  static String m59(p0) => "提交失败: ${p0}";

  static String m60(p0) => "${p0}（兼容模式）";

  static String m61(p0, p1) => "系统代理全机只有一份设置，后写者胜 —— 当前指向 ${p0}，不是易联的 ${p1}。";

  static String m62(p0) => "被其他软件接管 · ${p0}";

  static String m63(p0) => "被其他程序占用 · ${p0}";

  static String m64(p0) => "轻触断开  ·  ${p0}";

  static String m65(p0) => "${p0}；已临时启用「系统代理（兼容模式）」保证上网。";

  static String m66(p0) => "工单 #${p0}";

  static String m67(p0) => "流量 ${p0} GB";

  static String m68(p0) => "${p0}（设备接管）";
  ...
  static String m71(p0) => "版本号: ${p0}";

  static String m72(p0) => "v${p0} · 点击检查更新";

  static String m73(p0) => "易联接管中 · ${p0}";

  static String m74(p0) => "WebView 初始化失败:${p0}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "dashboard": MessageLookupByLibrary.simpleMessage("易联首页"),
    ...
    "details": m3,
    "detection": MessageLookupByLibrary.simpleMessage("网络检测"),
    ...
    "goDownload": MessageLookupByLibrary.simpleMessage("一键更新"),
    ...
    "shop": MessageLookupByLibrary.simpleMessage("购买套餐"),
    ...
    "tools": MessageLookupByLibrary.simpleMessage("我的账户"),
    ...
    "vgAnnouncements": MessageLookupByLibrary.simpleMessage("易联公告"),
    ...
    "vgCoexistFine": MessageLookupByLibrary.simpleMessage("请先完全退出它们再连接：TUN 模式不能与其他代理软件共存，否则会互相抢网络接管，出现「显示已连接但上不了网」。"),
    ...
    "vgNoPlanBanner": MessageLookupByLibrary.simpleMessage("你还没有套餐：可以先免费试用，或直接购买套餐，开通后点圆圈就能连上"),
    "vgPlanExpiredBanner": MessageLookupByLibrary.simpleMessage("套餐已到期：续费后即可继续使用"),
    "vgTryFreeFirst": MessageLookupByLibrary.simpleMessage("先免费试用"),
    "vgRenewNow": MessageLookupByLibrary.simpleMessage("去续费"),
    "vgUpdateLater": MessageLookupByLibrary.simpleMessage("稍后"),
    "vgInstallingUpdate": MessageLookupByLibrary.simpleMessage("正在安装新版本…"),
    "vgRelaunchingApp": MessageLookupByLibrary.simpleMessage("安装完成，正在重新打开易联…"),
    "vgInstallFallbackFinder": MessageLookupByLibrary.simpleMessage("自动安装未成功，已改为打开安装包：请把 Voguesly 拖到「应用程序」"),
    "vgTipConnectFirst": MessageLookupByLibrary.simpleMessage("第一次用？点一下圆圈就能连上，其他不用管。"),
    "vgTipsTitle": MessageLookupByLibrary.simpleMessage("新手小贴士"),
    "vgTipShopDesktop": MessageLookupByLibrary.simpleMessage("买套餐 / 续费：左侧栏「购买套餐」"),
    "vgTipShopMobile": MessageLookupByLibrary.simpleMessage("买套餐 / 续费：底栏「套餐」"),
    "vgTipSupportDesktop": MessageLookupByLibrary.simpleMessage("有问题找人：左侧栏「在线客服」"),
    "vgTipSupportMobile": MessageLookupByLibrary.simpleMessage("有问题找人：底栏「客服」"),
    "vgTipUpdateSubDesktop": MessageLookupByLibrary.simpleMessage("线路全红 / 连不上：先点左侧栏「更新订阅」"),
    "vgTipUpdateSubMobile": MessageLookupByLibrary.simpleMessage("线路全红 / 连不上：先到「我的」点「更新订阅」"),
    "support": MessageLookupByLibrary.simpleMessage("在线客服"),
    "vgNavHome": MessageLookupByLibrary.simpleMessage("首页"),
    "vgNavShop": MessageLookupByLibrary.simpleMessage("套餐"),
    "vgNavDetect": MessageLookupByLibrary.simpleMessage("检测"),
    "vgNavLines": MessageLookupByLibrary.simpleMessage("线路"),
    "vgNavSupport": MessageLookupByLibrary.simpleMessage("客服"),
    "vgNavMine": MessageLookupByLibrary.simpleMessage("我的"),
    "vgNavLinesDesktop": MessageLookupByLibrary.simpleMessage("切换线路"),
    "vgOpenPaymentFailed": MessageLookupByLibrary.simpleMessage("无法打开支付应用，请确认已安装微信／支付宝，或改用扫码支付"),
    "vgReauthorizeTun": MessageLookupByLibrary.simpleMessage("重新授权"),
    "vgTunAuthFailedTitle": MessageLookupByLibrary.simpleMessage("TUN 授权未通过"),
    "vgCaptchaTitle": MessageLookupByLibrary.simpleMessage("安全验证"),
    "vgCaptchaRequired": MessageLookupByLibrary.simpleMessage("请先完成安全验证"),
    "vgCaptchaUnavailable": MessageLookupByLibrary.simpleMessage("验证服务暂时不可用,请稍后再试"),
